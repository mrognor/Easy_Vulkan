...
# EV_VK_ValidationLayers binary
bin/EV_VK_ValidationLayers.o: EV_VK_ValidationLayers.cpp EV_VK_ValidationLayers.h
	mkdir -p bin
	g++ -c $(CXXFLAGS) EV_VK_ValidationLayers.cpp -o bin/EV_VK_ValidationLayers.o $(LDFLAGS)
